...
$myCreateToken = <<<JS
    ...
    */
    ...
    // MOSTRA LA SCHERMATA DI RICHIESTA INSERIMENTO DEL PIN
    ...
    pinVerifyButton.addEventListener('click', function(){
        $('#pinVerifyButton').html('<img width=20 src="'+ajax_loader_url+'" alt="'+Yii.t('js','loading...')+'">');
        //cripta il pin
        $.ajax({
    		url:'{$cryptoURL}',
    		type: "POST",
    ...
    var pinCancelButton = document.querySelector('#pinCancelButton');
    pinCancelButton.addEventListener('click', function(){
        isPinRequest = false;
    });
