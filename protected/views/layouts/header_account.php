	...
	<div class="account-item clearfix">
		...
		?>
			<div class="image img-cir img-120">
					<img src="<?php echo Yii::app()->user->objUser['picture']; ?>" alt="<?php echo Yii::app()->user->objUser['name']; ?>">
			</div>
			<img style="width:25px; height:25px; top:45px; left:-15px;" class="imgProvider image img-cir img-40" src="css/images/<?php echo Yii::app()->user->objUser['provider']; ?>.png" alt="img">
