...
<head>
    ...
    <meta name="description" content="Wallet TTS">
    <meta name="author" content="Wallet TTS">
    <meta name="keywords" content="Wallet TTS">

    <meta name="google-signin-client_id" content="584866932140-lkpdo6dortmlq67o4udcofseji4j9rc3.apps.googleusercontent.com">
...
<body class="animsition">
    ...
    <script>
    //We need to publish the translations to javascript for them to work.
    //You can publish all your translations in a single location, or publish only parts in specific places. (e.g. controller or view)
    //new JsTrans('app','it'); // abilita la traduizone dei testi yii in javascript
    </script>
