					...
					<tbody>
						<tr>
							<td style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif; color: #555; font-size: 14px;" valign="top">
								<div>
									<p style="font-size:34px;color:rgb(57,150,220)"><?php echo Yii::t('lang','Action required: Reset password');?></p>
								</div>
								<div>
									<p style="margin-top: 28px;font-size: 14px;"><?php echo Yii::t('lang','Be careful <strong>{email}</strong>!',array('{email}'=>$email));?></p>
								</div>
								<div>
									<p style="margin-top: 28px;font-size: 14px;"><?php echo Yii::t('lang','Someone requested to reset the password on your account.');?>
				          <br>
                        ...
                        <a href="<?php echo $URL;?>">
                            <button type="button" style="padding: 3px 3px 3px 3px;
                              ...
                              cursor: pointer;
                    					...
                    					min-width: 100px;
															min-height: 30px;
                    					text-shadow: 1px 1px 2px black;"><?php echo Yii::t('lang','Reset');?></button>
                        </a>

									</div>
									<div>
										<p style="margin-top: 28px;font-size: 14px;"><?php echo Yii::t('lang','Cheers');?>,
