...
//$(function(){
	...
	//$("button[name='tokenAvanti']").click(function(){
	...
	function updateconfirmMask(id_institute){
						  	...
						  	if (typeof data[0] !== 'undefined') {
								...
								writeData('sync-send-'+prefix, post)
									.then(function() {
										...
										return sw.sync.register('sync-send-'+prefix);
									})
									.then(function() {
										updateconfirmMask({$id_institute});
	...
	$(".copyonClickAddress").click(function(){
		if (!navigator.clipboard) {
		  	fallbackCopyTextToClipboard($('#inputcopyWalletAddress').val());
		  	return;
		}
